  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <div
        ...
        } focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-0 focus-visible:ring-${accent}-500/20`}
      >
        {checked && (
          <Check size={14} className="absolute inset-0.5 text-white pointer-events-none" />
        )}
      </div>
      {label && (
        <span
